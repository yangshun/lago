...
describe('depthFirstSearch', () => {
  ...
  test('graphs with two nodes', () => {
    ...
    expect(depthFirstSearch({ '1': ['1', '2'], '2': [] }, '1')).toEqual([
      '1',
      '2',
    ]);
  ...
  test('disjoint graphs', () => {
    expect(
      depthFirstSearch({ '1': ['2'], '2': [], '3': [], '4': ['3'] }, '1'),
    ).toEqual(['1', '2']);
    expect(
      depthFirstSearch({ '1': ['2'], '2': [], '3': [], '4': ['3'] }, '3'),
    ).toEqual(['3']);
    expect(
      depthFirstSearch({ '1': ['2'], '2': [], '3': [], '4': ['3'] }, '4'),
    ).toEqual(['4', '3']);
  });
});
