...
describe('Counter', () => {
  ...
  describe('mostCommon()', () => {
    test('unique frequencies', () => {
      ...
      expect(c.mostCommon(2)).toEqual([['c', 5], ['b', 4]]);
      expect(c.mostCommon(3)).toEqual([['c', 5], ['b', 4], ['a', 2]]);
      expect(c.mostCommon(4)).toEqual([['c', 5], ['b', 4], ['a', 2]]);
      expect(c.mostCommon()).toEqual([['c', 5], ['b', 4], ['a', 2]]);
    });
