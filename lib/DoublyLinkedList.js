...
class DoublyLinkedList {
  ...
  /**
   * Adds a new element to the front of the DoublyLinkedList
   * @param {*} element
   * @return {number} length The new length of the DoublyLinkedList.
   */
  unshift(element) {
  ...
  /**
   * Removes an element at the front of the DoublyLinkedList
   * @return {*} element The element being removed.
   */
  shift() {
    if (this.isEmpty()) {
      return undefined;
  ...
  /**
   * Removes an element from the back of the DoublyLinkedList
   * @return {*} element The element being removed.
   */
  pop() {
    if (this.isEmpty()) {
